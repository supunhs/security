...
/**
 * 
 * @author Tharindu Ishanka
 */
public class TripleDES {

//	 public static void main(String[] args) throws Exception {
//	 String text = "Ep1klanka";
//	 String codedtext = new TripleDES().encrypt(text, "SecretKey");
//	 String decodedtext = new TripleDES().decrypt(codedtext, "SecretKey");
